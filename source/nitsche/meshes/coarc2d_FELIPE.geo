...
Physical Surface(1) = {64};  								// inlet face
Physical Surface(2) = {86};								// outlet surface
Physical Surface(3) = {surf1, surf2, surf3, surf4, surf5, surf6, surf7, surf8, 63, 59, 55, 51, 85, 81, 77, 73};  	// Manto

Physical Volume(1) = {pipe_up[1], pipe_down[1], coarted_part};
