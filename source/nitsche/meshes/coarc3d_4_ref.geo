...
Physical Surface(1) = {24};   // Inlet
Physical Surface(2) = {62};   // Outlet
Physical Surface(3) = {32, 45, 66};   // Wall
Physical Surface(4) = {33, 50, 67};   // Symmetry
Physical Surface(5) = {12, 14, 16};   // Symmetry

Physical Volume(0) = {1, 2, 3};

Mesh.OptimizeNetgen = 1;
Mesh 3;
Save Sprintf('coarc3d4_f0.6_d0_h0.1.msh');
RefineMesh;
Save Sprintf('coarc3d4_f0.6_d0_h0.05.msh');
